...
public class SubscriptionStateMachineAdapter implements AttemptTransitionPort {
    ...
    public StateMachineEventResult<SubscriptionStatus, SubscriptionEvent> transitionSubscriptionStatus(AttemptTransitionSubscriptionStatus behavior) {
